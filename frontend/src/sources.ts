...
export const SOURCES: Source[] = [
  ...
  {
    id: "burgard-2005",
    short: "Burgard et al. 2005",
    authors: "W. Burgard, M. Moors, C. Stachniss & F. E. Schneider",
    year: "2005",
    title: "Coordinated Multi-Robot Exploration",
    venue: "IEEE Transactions on Robotics 21(3):376-386, DOI 10.1109/TRO.2005.844673",
    url: "https://doi.org/10.1109/TRO.2005.844673",
    category: "Coordination and communication delay",
    strength: "primary",
    modules: ["swarm"],
    grounds:
      "The canonical multi-robot exploration result: robots discount frontier targets others are already assigned to, cutting the redundant coverage that arises when agents pick the same target from a shared map. Grounds the neighbouring-field prior art for the coordination tax - the qualitative stale-map-wastes-trips mechanism is known in coverage robotics; this paper's contribution is the v/c scaling law in the interstellar setting where the delay is light-speed itself.",
  },
  {
    id: "amigoni-2017",
    short: "Amigoni, Banfi & Basilico 2017",
    authors: "F. Amigoni, J. Banfi & N. Basilico",
    year: "2017",
    title: "Multirobot Exploration of Communication-Restricted Environments: A Survey",
    venue: "IEEE Intelligent Systems 32(6):48-57, DOI 10.1109/MIS.2017.4531226",
    url: "https://doi.org/10.1109/MIS.2017.4531226",
    category: "Coordination and communication delay",
    strength: "primary",
    modules: ["swarm"],
    grounds:
      "Surveys multi-robot exploration when communication is limited or intermittent, where robots must act on partial, out-of-date shared maps. Grounds that exploration under a communication constraint is a studied problem in robotics, distinct from this work's finite-light-speed regime where the constraint is physical and the redundancy cost takes the clean v/c form.",
  },
  {
    id: "demers-1987",
