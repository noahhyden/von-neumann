...
export const SOURCES: Source[] = [
  ...
  {
    id: "clark-evans-1954",
    short: "Clark & Evans 1954",
    authors: "P. J. Clark & F. C. Evans",
    year: "1954",
    title: "Distance to Nearest Neighbor as a Measure of Spatial Relationships in Populations",
    venue: "Ecology 35(4):445-453, DOI 10.2307/1931034",
    url: "https://doi.org/10.2307/1931034",
    category: "Swarm dynamics and slingshots",
    strength: "primary",
    modules: ["swarm"],
    grounds:
      "The aggregation index R = observed mean nearest-neighbour distance over the Poisson expectation (R = 1 random, R < 1 clustered), the measured clumpiness axis for the swarm's clumpy-field robustness test. The 3D Poisson expectation E[NN] = 0.55396 rho^(-1/3) generalizes their 2D form and is used comparatively across fields at fixed N and box.",
  },
  {
    id: "thomas-cluster-process",
    short: "Thomas 1949; Neyman & Scott 1958",
    authors: "M. Thomas; J. Neyman & E. L. Scott",
    year: "1949",
    title: "A generalization of Poisson's binomial limit for use in ecology (Thomas); Statistical approach to problems of cosmology (Neyman & Scott)",
    venue: "Biometrika 36:18-25, DOI 10.1093/biomet/36.1-2.18; J. R. Stat. Soc. B 20:1-43",
    url: "https://doi.org/10.1093/biomet/36.1-2.18",
    category: "Swarm dynamics and slingshots",
    strength: "primary",
    modules: ["swarm"],
    grounds:
      "The parent-plus-offspring cluster point process used to generate the non-uniform (clumpy) star field: cluster centres scattered uniformly, stars placed Gaussian around them, with a scatter that interpolates cleanly to the uniform limit - which lets the clumpiness sweep use the uniform slope as a hard null.",
  },
  {
