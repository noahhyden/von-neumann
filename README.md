...
|---|---|---|
| [`closure-sim`](closure-sim/) | ✅ v1 | **Closure & replication.** Define a factory as a bill of materials; compute how much of itself it can build locally ("closure"), simulate how a seed multiplies over time, and analyze the "electronics wall" — why chips are the part that can't be made in space. Includes a plain-language [explainer](closure-sim/explainer.html). |
